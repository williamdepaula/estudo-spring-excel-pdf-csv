package br.paula.william.excelexport.service;

import br.paula.william.excelexport.Utils;
import br.paula.william.excelexport.model.User;
    ...
    public List<User> findAllUsers() {
        ...
        return IntStream.rangeClosed(1, 20)
                .mapToObj(i -> new User(appUtil.generateRandomChars(candidateChars, 10), appUtil.generateRandomChars
                        ...
                        10), appUtil.generateRandomChars(candidateChars, 10)))
